...
export const Button = ({ text, variant = 'default', onClick, classname, size }: { text: string, classname?: string, variant?: 'default' | 'secondary', onClick: any, size?: 'default' | 'sm' | 'lg' | 'icon' }) => {
